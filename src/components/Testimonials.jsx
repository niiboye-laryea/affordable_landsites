...
const Testimonials = () => {
    return (<>
        <div className="w-full pt-20 px-10 text-center">
            <p className="font-bold text-5xl text-sky-500 mb-10">What our customers say</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 pb-20">
                <div className="testimonies grid grid-cols-1 text-center">
                    <div>
                        ...
                        <p className="mt-5 font-bold text-[18px]">Joshua</p>
                    ...
                    <div>
                        <p className="px-10 pb-10 pt-5 text-[20px]">
                ...
                <div className="testimonies grid grid-cols-1 text-center">
                    <div>
                        ...
                        <p className="mt-5 font-bold text-[18px]">Micky</p>
                        <p className="flex flex-row justify-center gap-3 p-3 mr-auto ml-auto">
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                ...
                <div className="testimonies grid grid-cols-1 text-center">
                    <div>
                        ...
                        <p className="mt-5 font-bold text-[18px]">Bismark</p>
                        <p className="flex flex-row justify-center gap-3 p-3 mr-auto ml-auto">
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                ...
                <div className="testimonies grid grid-cols-1 text-center">
                    <div>
                        ...
                        <p className="mt-5 font-bold text-[18px]">Judith</p>
                        <p className="flex flex-row justify-center gap-3 p-3 mr-auto ml-auto">
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
                            <Star className="w-5 h-5 text-green-500 fill-green-500" />
